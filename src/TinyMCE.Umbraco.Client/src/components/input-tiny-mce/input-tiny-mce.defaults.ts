...
export const defaultFallbackConfig: RawEditorOptions = {
	...
	extended_valid_elements:
		'@[id|class|style],+umb-rte-block[!data-content-key],+umb-rte-block-inline[!data-content-key],ins[datetime|cite],figure,figcaption,iframe[*],-div[contenteditable|data-embed-url|data-embed-height|data-embed-width|data-embed-constrain]',
