(function () {
    ...
    /**
     * @ngdoc directive
     * @name umbraco.directives.directive:tinyMcePremiumRtePropertyEditor
     * @function
     *
     * @description
    ...
    angular
        .module("umbraco")
        .component("tinyMcePremiumRtePropertyEditor", {
            templateUrl: "/App_Plugins/TinyMCE.Umbraco.Premium/tiny-mce-premium-rte-property-editor.html",
            controller: TinyMcePremiumBlockRteController,
            controllerAs: "vm",
            bindings: {
                model: "="
            },
    ...
    function TinyMcePremiumBlockRteController($element, $scope, $q, $timeout, $interpolate, assetsService, editorService, clipboardService, localizationService, overlayService, blockEditorService, udiService, serverValidationManager, angularHelper, eventsService, $attrs, tinyMceAssets, tinyMceService) {
