...
public class RichTextEditorSettings
{
    ...
    private static readonly string[] _default_plugins =
    {
        "anchor", "charmap", "table", "lists", "advlist", "autolink", "directionality", "searchreplace",
    };

    private static readonly RichTextEditorCommand[] _default_commands =
    {
    ...
    /// </summary>
    public RichTextEditorCommand[] Commands { get; set; } = _default_commands;

    /// <summary>
    ///     HTML RichText Editor TinyMCE Plugins.
    /// </summary>
    public string[] Plugins { get; set; } = _default_plugins;
