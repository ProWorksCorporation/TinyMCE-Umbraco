...
This is an Umbraco CMS package that brings TinyMCE Rich Text Editor back to Umbraco v16+ (targets v18.0.0). It replaces the default TipTap editor and supports both open-source and premium TinyMCE plugins. The package consists of three main projects:
...
- The package targets .NET 10.0 and Umbraco 18.0.0
