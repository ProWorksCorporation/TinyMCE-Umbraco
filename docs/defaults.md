...
The Umbraco:CMS:ValidElements item allows the following tags by default.

> Defined as `StaticValidElements` in
> [`src/TinyMCE.Umbraco/Configuration/RichTextEditorSettings.cs`](../src/TinyMCE.Umbraco/Configuration/RichTextEditorSettings.cs),
> which is the authority — update this page whenever that constant changes.
